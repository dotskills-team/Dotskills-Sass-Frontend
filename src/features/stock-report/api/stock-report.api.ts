...
export const stockReportApi = baseApi.injectEndpoints({
  endpoints: (builder) => ({
    listStockReport: builder.query<ListResult<StockReportEntry>, ListStockReportParams>({
      query: ({ companyId, productId, variantId, locationId, page, belowReorderOnly, limit }) => ({
        url: `/companies/${companyId}/reports/stock`,
        params: { productId, variantId, locationId, page, belowReorderOnly, limit },
      }),
    ...
    exportStockReport: builder.query<Blob, ExportStockReportParams>({
      query: ({ companyId, productId, variantId, locationId, belowReorderOnly }) => ({
        url: `/companies/${companyId}/reports/stock/export`,
        params: { productId, variantId, locationId, belowReorderOnly },
