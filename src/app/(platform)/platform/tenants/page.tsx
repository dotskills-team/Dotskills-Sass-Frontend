...
import { tenantsColumns } from "@/features/tenant/components/tenants-columns";
...
const TENANT_STATUSES: TenantStatus[] = ["DRAFT", "TRIAL", "ACTIVE", "SUSPENDED", "CANCELLED"];
...
export default function TenantsPage() {
  ...
  return (
    <PlatformPermissionGate permission={PLATFORM_PERMISSIONS.TENANT_READ} fallback={<PermissionDenied />}>
